...
from utils.attendance_utils import ATTENDANCE_FLOOD_GUARD_SECONDS
...
def parse_args() -> argparse.Namespace:
    ...
    if sys.platform != "win32":
        _linux_sdk = PROJECT_ROOT / "hikvision_sdk_linux"
        _default_sdk = str(_linux_sdk) if _linux_sdk.exists() else str(PROJECT_ROOT / "hikvision_sdk")
    else:
        _default_sdk = str(PROJECT_ROOT / "hikvision_sdk")
