...
def _build_reports_rows(
    ...
    *,
    ...
    is_holiday = _build_holiday_checker(db, target_day_start.date(), allowed_org_ids)
    ...
    for emp in employees:
        ...
        if is_holiday(emp.organization_id):
            continue
...
def get_notifications(request: Request, db: Session) -> dict:
    ...
    is_holiday = _build_holiday_checker(db, today_start.date(), allowed_org_ids)
